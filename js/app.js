...
const loadProducts = () => {
    ...
    // calling showProducts function with data parameter
    showProducts(data);
};
// api ends here 

// show all product in UI Done
const showProducts = (products) => {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button class="btn btn-danger" onclick="seeDetails('${product.id}')">Details</button>
      </div>
      `;
...
const updateTotal = () => {
    ...
    cart.total = parseFloat(document.getElementById('total').innerText);
    cart.count = parseFloat(document.getElementById('total-Products').innerText);
    cart.price = parseFloat(document.getElementById('price').innerText);
    cart.tax = parseFloat(document.getElementById('total-tax').innerText);
    cart.charge = parseFloat(document.getElementById('delivery-charge').innerText);
...
const loadFromLocalStorage = () => {
    const cartStrinigyfied = localStorage.getItem('cart')
    if (cartStrinigyfied !== undefined) {
        const cart = JSON.parse(cartStrinigyfied)
        document.getElementById('total').innerText = cart.total
        document.getElementById('total-Products').innerText = cart.count
        document.getElementById('price').innerText = cart.price
        document.getElementById('total-tax').innerText = cart.tax
        document.getElementById('delivery-charge').innerText = cart.charge
    }
}
